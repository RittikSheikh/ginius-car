...
const CarouselItem = ({ data }) => {
  ...
  return (
    <div id={`slide${id}`} className="carousel-item relative w-full">
      ...
      <div className="absolute flex justify-between transform -translate-y-1/2 mt-7 top-3/4 left-5 md:left-24 w-3/4 md:w-[400px]">
        <button className="btn  btn-secondary md:w-[170px] md:h-[56px]">Discover More</button>
        <button className="btn btn-outline text-white hover:btn-secondary md:w-[170px] md:h-[56px]">Latest Project</button>
      </div>
